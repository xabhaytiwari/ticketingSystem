...
class Ticket(models.Model):
    ...
    ticket_type = models.CharField(max_length=20, choices=(('Bug', 'Bug'), ('Compatibility Issue', 'Comaptibility Issue'), ('General', 'General')), default='General')
    ...
    severity = models.CharField(max_length=5, choices=(('A', 'A'), ('B', 'B'), ('C', 'C')), default = 'B')
